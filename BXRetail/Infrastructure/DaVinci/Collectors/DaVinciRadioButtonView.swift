...
struct DaVinciRadioButtonView: View {
                ...
                ForEach(field.options, id: \.value) { option in
                    HStack {
                        Button(action: {
                            ...
                            HStack {
                                Circle()
                                    .stroke(selectedOption == option.value ? Color(K.Colors.Primary) : Color.gray, lineWidth: 2)
                                    .frame(width: 20, height: 20)
                                    .overlay(
                                        Circle()
                                            .fill(selectedOption == option.value ? Color(K.Colors.Primary) : Color.clear)
